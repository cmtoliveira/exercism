...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    new_rate = exchange_rate + exchange_rate*spread/100        #New exchange rate
    exchange = exchange_money(budget,new_rate)        #Exchanged value
    number_of_bills = get_number_of_bills(exchange,denomination)        #Number of bills
    max_value = get_value_of_bills(denomination,number_of_bills)        #Max value in cash
    return max_value
