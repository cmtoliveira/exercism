...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    if temperature < 800 and neutrons_emitted > 500 and product < 500000: return True
    return False
...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    percentage_value = generated_power*100/theoretical_max_power
    if percentage_value >= 80: return 'green'
    elif 60 <= percentage_value < 80: return 'orange'
    elif 30 <= percentage_value < 60: return 'red'
    elif percentage_value < 30: return 'black'
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    close_to_threshold = 0.9*threshold <= product <= 1.1*threshold 
    if product < 0.9*threshold: return 'LOW'
    elif close_to_threshold: return 'NORMAL'
    return 'DANGER'