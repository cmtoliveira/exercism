...
bool lost(bool power_pellet_active, bool touching_ghost) {
    ...
    return !can_eat_ghost(power_pellet_active, touching_ghost) and touching_ghost;
}
...
bool won(bool has_eaten_all_dots, bool power_pellet_active,
    ...
    return has_eaten_all_dots == true and lost(power_pellet_active,touching_ghost) == false;
}
